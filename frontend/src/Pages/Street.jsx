...
const Street = () => {
  ...
  return (
    <Container>
      ...
      <Header>
      <Heading heading="Street Photography" para="From early morning commutes to neon-tinted nights, our streets have become the fabric of our shared history. This category encompasses street photography in every form." />
      <HeadingSideCard />
    </Header>
      <ImageDiv>
        {data?.map((item) => (
