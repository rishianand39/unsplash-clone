...
const Experimental = () => {
  ...
  return (
    <Container>
      ...
      <Header>
      <Heading heading="Experimental" para="Through the use of unlikely textures, intriguing subject matter, and new formats — photography has the power to challenge our perspectives and push creativity forward."/>
      <HeadingSideCard />
    </Header>
      <ImageDiv>
        {data?.map((item) => (
