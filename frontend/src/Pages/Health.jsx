...
const Health = () => {
  ...
  return (
    ...
    <Header>
      <Heading heading="Health and Wellness" para="Celebrate a healthy mind, body and soul with photographs that showcase everything from new medical discoveries and alternative medicines, to healthy eating and meditation."/>
      <HeadingSideCard />
    </Header>
      <ImageDiv>
        {data?.map((item) => (
