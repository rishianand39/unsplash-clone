...
const Atheltics = () => {
  ...
  return (
    ...
    <Header>
      <Heading heading="Atheltics" para="Ready, set, snap. Capturing action in the every day — from the tough gym workouts to the tense basketball games out on the court."/>
      <HeadingSideCard />
    </Header>
      <ImageDiv>
        {data?.map((item) => (
