...
const Food = () => {
  ...
  return (
    ...
    <Header>
      <Heading heading="Food and Drink" para="It’s time to indulge, and throw yourself into the world of culinary photography — with shots of elaborate dinner parties, decadent pastries and more."/>
      <HeadingSideCard />
    </Header>
      <ImageDiv>
        {data?.map((item) => (
