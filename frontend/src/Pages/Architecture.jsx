...
const Architecture = () => {
  ...
  return (
    ...
    <Header>
    <Heading heading="Architecture" para="Explore exteriors from around the world — from brutalist buildings to minimalist structures that will give you a new appreciation for the art of architecture."/>
      <HeadingSideCard />
    </Header>
      <ImageDiv>
        {data?.map((item) => (
