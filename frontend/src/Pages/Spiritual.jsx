...
const Spiritual = () => {
  ...
  return (
    <Container>
      ...
      <Header>
      <Heading heading="Spirituality" para="Photography has the ability to examine life’s big questions, by exploring themes of love, loss, healing and human connection."/>
      <HeadingSideCard />
    </Header>
      <ImageDiv>
        {data?.map((item) => (
